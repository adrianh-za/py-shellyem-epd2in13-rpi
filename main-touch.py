...
try:
    ...
    # Init the touch screen (uses I2C so remember to check correct address for your RPi)
    gt = gt1151.GT1151(0x14)
    GT_Dev = gt1151.GT_Development()
    GT_Old = gt1151.GT_Development()
    gt.GT_Init()
    
    # Thread to track touches
    touchThread = threading.Thread(target = touchCheck)
    ...
    while (1):
        ...
        if(GT_Dev.TouchpointFlag):
            # TO be updated with something later
